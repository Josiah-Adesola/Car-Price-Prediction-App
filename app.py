...
@app.route("/%7B%7B%20url_for('predict')%7D%7D", methods=['POST'])
def predict():
    Fuel_Type_Diesel=0
    if request.method == 'POST':
        ...
        if output<0:
            ...
            return render_template('index.html',prediction_text="You Can Sell The Car at {} Million Naira".format(output))
    else:
        return render_template('index.html')
